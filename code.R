...
graficos(SVAR_3_s1_c_pcom, 800, 800, 2)
# 
# # IRF (bootstrap)
...
graficos(SVAR_3_s2_c_pcom, 800, 800, 2)
...
graficos(SVAR_3_s3_c_pcom, 800, 800, 2)
# 
# # IRF (bootstrap)
# SVAR.SIRF.boot <- SVAR.sirf.boot(SVAR, Amat, Bmat, Yb, pmax, H, a, R)
# 
...
# SVAR estimation (AB model configuration)
SVAR_6<- SVAR(VAR, Amat = Amat, Bmat = Bmat, lrtest = FALSE)
SVAR
...
graficos(SVAR_7_c_pcom, 800, 800)
...
Yb <- Yb_7_s_pcom 
SVARS(SVAR_7_s_pcom, 2, 1)
graficos(SVAR_7_s_pcom, 800, 800)
...
graficos(SVAR_8_c_pcom, 800, 800)
...
SVARS(SVAR_8_s_pcom, 2, 1)
graficos(SVAR_8_s_pcom, 800, 800)
...
graficos(SVAR_9_c_pcom, 800, 800)
...
SVARS(SVAR_9_s_pcom, 2, 1)
graficos(SVAR_9_s_pcom, 800, 800)
